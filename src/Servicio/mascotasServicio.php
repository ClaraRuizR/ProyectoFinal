...
class MascotasServicio{
    ...
    function obtener($filtro, $textoFiltro){
        ...
        foreach ($arrayMascotas as $mascota){
            ...
            $mascotasServicio->Init($mascota['ID'], $mascota['pasaporte'], $mascota['nombre'], $mascota['id_titular'], $mascota['especie'], $mascota['raza'], $mascota['sexo'], $mascota['color'], $mascota['codigo_chip'], $mascota['fecha_nacimiento'], $mascota['operado'], $mascota['fecha_alta']);
            
            array_push($listaMascotas, $mascotasServicio);
        }
