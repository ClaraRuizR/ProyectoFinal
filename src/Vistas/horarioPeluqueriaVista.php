...
$arrayReservas = $reservasServicio->buscarReservas(date('Y-m-d', strtotime("+$contadorSemana week 0 days")), date('Y-m-d', strtotime("+$contadorSemana week 6 days")), "Peluquería");
?>
