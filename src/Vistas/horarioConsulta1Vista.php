...
$arrayReservas = $reservasServicio->buscarReservas(date('Y-m-d', strtotime("monday -$contadorSemana week")), date('Y-m-d', strtotime("friday -$contadorSemana week")), "Consulta 1");
    ...
    <div class="contenedor">
        ...
        <div class="cuerpo"><?php
            ...
            echo"<fieldset>";
                ...
                echo"<a href='horarioConsulta1Vista.php?contadorSemana=".$semanaMas."'>Semana siguiente</a><br>";
                echo"<a href='horarioConsulta1Vista.php?contadorSemana=".$semanaMenos."'>Semana anterior</a>";
            ...
            <fieldset>
                ...
                <form action="reservaRegistradaVista.php" method='POST'>
                    ...
                    <select name="sala" id="sala" value='consulta1' required>
